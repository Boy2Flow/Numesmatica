...
const coins = [
  ...
  },
  {
    ...
    price: 110,
    images: [],
    description: "Tauler 168 lote 1693 EBC. Resto B.0",
    featured: false,
    views: 0,
    stock: 1
  },
  {
    ...
    price: 70,
    images: [],
    description: "Tauler 168 lote 1698 EBC. Resto B.0",
    featured: false,
    views: 0,
    stock: 1
  },
  {
    id: "cuba-10-5-pesos-1975",
    name: "10 y 5 Pesos — Cuba",
    year: 1975,
    period: "extranjeras",
    continent: "america-central",
    ruler: "República",
  ...
  {
    id: "usa-1-dolar-1983",
    name: "1 Dólar — USA (San Francisco)",
    year: 1983,
    period: "extranjeras",
    continent: "america-norte",
    ruler: "Liberty",
  ...
  {
    id: "esp-5-pesetas-1891",
    name: "5 Pesetas — España",
    year: 1891,
    period: "borbones",
    ruler: "Alfonso XIII",
    country: "España",
    ...
    price: 60,
    images: [],
    description: "Atreyu estrella 91",
    featured: false,
    views: 0,
    stock: 2
  },
  ...
  {
    id: "canada-2-dolar-2012",
    name: "2 Dólar — Canadá (Perth)",
    year: 2012,
    period: "extranjeras",
    continent: "america-norte",
    ruler: "Elizabeth II",
    ...
    price: 190,
    images: [],
    description: "Ricardo MM 140",
    featured: false,
    views: 0,
    stock: 1
  },
  {
    id: "lote-duros-pce521",
    name: "Duros 5 Pesetas — Lote",
    year: 1870,
    period: "borbones",
    ruler: "Varios",
    country: "España",
    ...
    price: 37.5,
    images: [],
    description: "Lote de duros de 5 pesetas (#PCE521)",
    featured: false,
    views: 0,
    stock: 9
  },
  {
    id: "lote-medio-dolar-pcusa",
    name: "½ Dólar USA — Lote",
    year: 0,
    period: "extranjeras",
    continent: "america-norte",
    ...
    price: 0,
    images: [],
    description: "Lote de medio dólar USA (#PCUSA)",
    featured: false,
    views: 0,
    stock: 9
  },
  {
    ...
    price: 0,
    images: [],
    description: "American Silver Eagle (#OZ999)",
    featured: false,
    views: 0,
    stock: 16
  },
  {
    id: "onza-pert-dr-oz999",
    name: "2 Onzas Pert Dragon",
    year: 2024,
    period: "bullion",
    continent: "asia",
    ruler: "N/A",
  ...
  },
  {
    ...
    price: 0,
    images: [],
    description: "20 Francos Oro (Napoleón/Gallo)",
    featured: false,
    views: 0,
    stock: 1
  },
