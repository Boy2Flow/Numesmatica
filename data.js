const COINS_DATA = [
  ...
  {
    id: "moneda-3-borbones",
    name: "8 Reales — Carlos III 'Busto'",
    year: 1772,
    period: "borbones",
    ruler: "Carlos III",
    country: "España",
    ...
    condition: "MBC",
    price: 450,
    images: ["https://picsum.photos/802/802", "https://picsum.photos/802/803"],
    description: "El famoso 'Spanish Dollar' que circuló por todo el mundo. El diseño de busto de Carlos III sustituyó al tipo columnario, estableciendo un estándar mundial de pureza y valor.",
    history: "Carlos III, el 'Político', reformó la administración de las cecas americanas para optimizar la producción. Estas piezas fueron la base económica sobre la que se construyó el futuro dólar estadounidense.",
    featured: true,
    views: 2100,
    stock: 0
  },
  {
    id: "moneda-4-republica",
    name: "5 Pesetas — Gobierno Provisional",
    year: 1933,
    period: "republica",
    ruler: "II República",
    country: "España",
    ...
    condition: "EBC",
    price: 65,
    images: ["https://picsum.photos/803/803", "https://picsum.photos/803/804"],
    description: "Moneda icónica de la II República Española con la alegoría de la matrona sentada. Acuñada en plata de 900 milésimas.",
    history: "Tras la caída de Alfonso XIII, la República buscó una iconografía que rompiera con el pasado monárquico, recuperando la matrona de las emisiones del s. XIX.",
    featured: false,
    views: 540,
    stock: 8
  },
